...
let lebel = document.body.children[6].children[1];
...
// 15. Select all the img element and log the number of element saying `The total number of img element is ---`
 ...
 let imagelength = document.querySelectorAll('img');
 console.log(`The total number of img element is ${imagelength.length}`);
...
console.log(document.querySelectorAll('lebel').length);
