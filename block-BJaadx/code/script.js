...
let level = document.body.children[6].children[1];
...
let attrPassword = document.body.children[6].children[4];
...
// 15. Select all the img element and log the number of element saying `The total number of img element is ---`
 ...
 let imagelength = document.body.children[3]
 console.log(imagelength.children.length);
...
document.querySelectorAll('lebel');
...
let topic = topics.lastElementChild
