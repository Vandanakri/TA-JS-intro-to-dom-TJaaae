...
let rm = document.querySelector('.box one');
rm.forEach((ele) => {
  ele.rm.remove()
})
...
let box = document.querySelector('.box four awesome-box')
...
imgElm = `https://images.unsplash.com/photo-1592500595497-d1f52a40b207?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=80`
